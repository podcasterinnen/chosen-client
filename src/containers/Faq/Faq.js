  ...
  render() {
    return (
      <section className="faq main__section">
        ...
        <p>Jede nicht-binäre Podcastendeperson/Podcasterin die einen eigenen Podcast produziert und/oder in einem festen Team podcastet kann sich bei uns ein Profil anlegen.</p>
        ...
        <p>Jede Podcastendeperson kann sich ihr persönliches Profil anlegen. Allerdings gibt es einen Ausschluss. Wir werden keinen Menschen bei uns eine Plattform bieten, die aus dem rechten Spektrum (AfD, Identitären, Pegida, etc) kommen oder mit ihrem Podcast rechte oder antisemitische Hetze verbreiten. Menschenverachtung, Sexismus und rechter Hetze werden wir hier keinen Raum geben. Sollte dir ein solches Profil auffallen, melde dich bitte bei uns: <a href="mailto:contact@podcasterinnen.org">contact@podcasterinnen.org</a></p>
        ...
        Wenn du dein Profil einrichtest, kannst du deinem Podcast verschiedenen Kategorien zuordnen. So wissen Besucher:innen deines Profils gleich, um welche Themen sich dein Format inhaltlich dreht und zu welchen Themen du gerne sprechen möchtest. Besucher:innen können nach Schlagwörten suchen und finden sofort die passenden Profile zu ihrem Thema.<br/>
