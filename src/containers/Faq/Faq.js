  ...
  render() {
    return (
      <section className="faq main__section">
        ...
        <p>In erster Linie lebt eine solche Webseite davon, dass du sie nutzt und die Idee dahinter in die Welt tragt. Also: Schau dich um, vernetzt euch und supportet andere Podcasterinnen. Erzählt Podcasterinnen das es diese Webseite gibt und warum sie sich hier anmelden sollten.<br/>Wir freuen uns über jedwede Form der ideellen Unterstützung. Erwähnt podcasterinnen.org in euren Podcasts. Schreibt über uns. Erzählt Veranstalter:innen und allen, die podcastende Expertinnen zu einer riesigen Vielfalt an Themen suchen, dass sie hier fündig werden. Sharing is caring.<br/><a href="https://podcasterinnen.org">podcasterinnen.org</a> ist ein Open Source Projekt und kann immer auch technische Unterstützung gebrauchen - im Großen wie im Kleinen.<br/>
        ...
        <p>Zuerst musst du dich bei podacsterinnen.org registrieren. Dafür klicke links oben auf den Menüpunkt „Login/Registrieren“<br/>Dort findest du den Login- und den Registrierungsbereich. Klicke auf „“Registrieren”“ und gibebe deine Mailadresse sowie zweimal dein Passwort an, klick dann auf „Submit“.Du bekommst nun eine E-Mail an die angegebene Adresse mit einem Bestätigungslink. Du klickst auf den Link und wirst automatisch auf die Seite von podcasterinnen.org zurückgeleitet. Nun musst du dich einloggen. Diesmal gibst du also unter „“Login“” deine E-Mail-Aadresse und dein Passwort ein. Jetzt kannst du mit dem Ausfüllen deines Profils beginnen.</p>
