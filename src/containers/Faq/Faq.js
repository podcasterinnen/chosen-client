  ...
  render() {
    return (
      <section className="faq main__section">
        ...
        <h3> Wer kann sich bei podcasterinnen.org ein Profil anlegen?</h3>
        ...
        <h3>Wie melde ich mich bei podcasterinnen.org an?</h3>
        ...
        <h3>Wie sieht ein gut ausgefülltes Profil aus?</h3>
        ...
        <h3>Warum gibt es meine Kategorie (meinen Tag, mein Schlagwort) nicht?</h3>
