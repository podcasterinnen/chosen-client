...
const content = [{
  copy: 'Jede nicht-binäre Podcastendeperson/Podcasterin die einen eigenen Podcast produziert und/oder in einem festen Team podcastet kann sich bei uns ein Profil anlegen.',
  index: 0,
  ...
  copy: 'In erster Linie lebt eine solche Webseite davon, dass du sie nutzt und die Idee dahinter in die Welt trägst. Also: Schau dich um, vernetze dich und supporte andere Podcastendeperson und Podcasterinnen. Erzähl anderen, dass es diese Webseite gibt und warum sie sich hier anmelden sollten.</p><p>Wir freuen uns über jedwede Form der ideellen Unterstützung. Erwähne podcasterinnen.org in deinem Podcasts. Schreib über uns. Erzähl Veranstalter:innen und allen, die podcastende Expertinnen zu einer riesigen Vielfalt an Themen suchen, dass sie hier fündig werden. Sharing is caring.</p><p><a href="https://podcasterinnen.org">podcasterinnen.org</a> ist ein Open Source Projekt und kann immer auch technische Unterstützung gebrauchen - im Großen wie im Kleinen. Du bist Entwicklerin und möchtest einen Beitrag zu podcasterinnen.org leisten? Auch kleine Bausteine können uns schon weiterhelfen. Also nur Mut - melde dich gerne via <a href="https://twitter.com/podcasterinnen" target="_blank">Twitter</a> oder <a href="mailto:contact@podcasterinnen.org">E-Mail</a>, wir freuen uns. Natürlich kannst du auch direkt mit Programmieren loslegen. Den Sourcecode für das <a href="https://github.com/podcasterinnen/chosen-api" target="_blank">Backend</a> und das <a href="https://github.com/podcasterinnen/chosen-client" target="_blank">Frontend</a> findest du auf unserer <a href="https://github.com/podcasterinnen/" target="_blank">Github-Seite</a>. Wir freuen uns über Bug-Tickets, Verbesserungsvorschläge und Pull-Requests.',
  index: 7,
  ...
  render() {
    return (
      <section className="faq main__section">
        ...
        <p>Bisher fehlt leider noch eins der wichtigsten Features: Die Kontaktaufnahme über podcasterinnen.org zu euch. Wir werden das Feature so schnell wie möglich implemetieren. Da ihr aber sowohl die Webseite eures Podcasts und auch eure Twitter-Handle mit eintragen könnt, denken wir, dass Personen die euch suchen, auf diesem Weg auf euch zukommen können. Wir wissen, dass das keine ideale Lösung ist und arbeiten daran, die Situation einfacher und mit weniger Klicks zu gestalten. Wir möchten euch trotzdem darum bitten, weder eure E-Mail-Adresse noch eure Handynummer in eurem Profil anzugeben.</p>
      </section>
    )
  }
}
