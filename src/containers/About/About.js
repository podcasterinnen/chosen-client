  ...
  render() {
    return (
      <section className="about main__section">
        ...
        <p>Dazu könnt ihr, als Podcasterin oder Podcastendeperson, euch auf dieser Webseite ein aussagekräftiges Profil anlegen und damit euch und eure Podcasts präsentieren. Besucher:innen von <a href="https://podcasterinnen.org">podcasterinnen.org</a> können hier nicht nur neue Formate entdecken, sondern auch Impulse und Ideen, z. B. für Veranstaltungen oder einzelne Podcast-Episoden mitnehmen. Die Seite richtet sich also auch an Podcaster:innen, die auf der Suche nach passenden Gesprächspersonen sind, oder Veranstalter:innen, die mit Expertinnen zu bestimmten Themengebieten in Kontakt treten möchten.</p>
