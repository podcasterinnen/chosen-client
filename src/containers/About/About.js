    ...
    return (
      <section className="about main__section">
        ...
        <section className="founder">
          <div className="founder__textcontainer">
            <h3 className="founder__h3">Daniela Ishorst – die Podcasterin.</h3>
        ...
        <section className="founder">
          <div className="founder__textcontainer--alt">
            <h3 className="founder__h3">Michaela Lehr – die Entwicklerin.</h3>
          ...
          <div className="founder__imagecontainer--alt">
            <img className="founder__imagecontainer__image" src={photoMichaela} alt="Michaela Lehr" />
          </div>
        </section>
        <section className="founder">
          <div>
            <h3 className="founder__h3">Nele Heise – die Stimme aus dem Off.</h3>
